...
// 9/29/2014
// this file picking.cpp - contains main() and picking routine
...
void HelpMenu( ) {
   ...
   sh[ 7] = "\n g: toggle between GLSL program and fixed function pipline           ";
...
{  Object   O;                   double  m;            // scratch: for mag3
   ...
   gluUnProject( double(wx),double(wy), zz, modelMatrix, projMatrix,viewPort, &xx,&yy,&zz );
...
void initScene (int argc, char **argv)
{
   ...
   sg.add(Object("cube",     -3.f,-3.f,0.f,  60.f,-0.7f,1.0f,0.4f, .7f,.6f,.9f,
	                         .3f,.3f,.3f,  .6f,.2f,.8f,  .70f,.70f,.70f, 100.f, 9, 2));
   sg.add(Object("cube",     -2.f,-3.f,-9.f, 80.f,-0.7f,1.0f,0.4f, .8f,.8f,.8f, 
	                         .3f,.3f,.3f,  .0f,.8f,.7f,  .50f,.50f,.50f,  90.f,10, 2));
   sg.add(Object("boxr.ply",  3.f,-1.f,0.f,  50.f,-0.7f,1.0f,0.4f, .5f,.7f,.4f, 
	                         .6f,.6f,.6f,  .6f,.2f,.8f,  .70f,.70f,.70f, 120.f, 7, 2)); 
   sg.add(Object("pyrm2.ply", 4.f, 1.f,2.f, 80.f, 0.0f,1.0f,0.0f, .7f,.7f,.7f, 
	                         .3f,.3f,.3f,  .9f,.1f,.6f,  .63f,.63f,.63f,  75.f, 9, 2));  
   sg.add(Object("pyrm2.ply", 4.f, 2.f,-8.f, 80.f, 0.0f,1.0f,0.0f, .7f,.7f,.7f,
	                         .3f,.3f,.3f,  .9f,.1f,.6f,  .63f,.63f,.63f,  75.f, 0, 2));    
   sg.add(Object("tetra2.ply", -3.f, 0.f,0.f,  50.f,-0.7f,1.0f,0.4f, .7f,.7f,.7f, 
	                         .5f,.5f,.5f,  .7f,.2f,.4f,  .60f,.60f,.60f,  80.f, 0, 2));
// sg.add(Object("pyrm.ply",  0.f, 2.0f,7.f,120.f, 0.0f,1.0f,0.0f, .5f,-.5f,.5f,
//                           .5f,.5f,.5f,  .1f,.1f,.8f,  .63f,.73f,.63f, 100.f, 7, 2));
// sg.add(Object("pyrm.ply",  0.f,1.5f,7.f,-120.f, 0.0f,1.0f,0.0f, .5f,.8f,.5f,
//                           .5f,.5f,.5f,  .1f,.1f,.8f,  .63f,.73f,.63f, 100.f, 5, 2));
